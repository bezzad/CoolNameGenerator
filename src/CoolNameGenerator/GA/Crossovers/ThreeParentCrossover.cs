...
namespace CoolNameGenerator.GA.Crossovers
{
    ...
    ///         If same then the bit is taken for the offspring otherwise the bit from the third parent is taken for the
    ///         offspring.
    ...
    public class ThreeParentCrossover : CrossoverBase
    {
        ...
        protected override IList<IChromosome> PerformCross(IList<IChromosome> parents)
        {
            ...
            for (var i = 0; i < parent1.Length; i++)
            {
                ...
                offspring.ReplaceGene(i, parent1Gene == parent2Genes[i] ? parent1Gene : parent3Genes[i]);
            }
