...
namespace CoolNameGenerator.GA.Crossovers
{
    ...
    ///     <remarks>
    ///         Results in a change in length of the children strings. The reason for this difference is that each parent
    ///         string has a separate choice of crossover point.
    ...
    public class CutAndSpliceCrossover : CrossoverBase
    {
        ...
        protected override IList<IChromosome> PerformCross(IList<IChromosome> parents)
        {
            ...
            var parent1Point = FastRandom.Next(1, parent1.Length) + 1;
            var parent2Point = FastRandom.Next(1, parent2.Length) + 1;
        ...
        private static IChromosome CreateOffspring(IChromosome leftParent, IChromosome rightParent, int leftParentPoint,
            int rightParentPoint)
        {
