...
namespace CoolNameGenerator.GA.Crossovers
{
    ...
    public class OrderBasedCrossover : CrossoverBase
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="OrderBasedCrossover"/> class.
        /// </summary>
        ...
        protected override IList<IChromosome> PerformCross(IList<IChromosome> parents)
        {
            ...
            var swapIndexesLength = FastRandom.Next(1, firstParent.Length - 1);
            var swapIndexes = FastRandom.GetUniqueInts(swapIndexesLength, 0, firstParent.Length);            
        ...
        protected virtual IChromosome CreateChild(IChromosome firstParent, IChromosome secondParent, int[] swapIndexes)
        {
            ...
            for (int i = 0; i < firstParent.Length; i++)
            {
                ...
                // We add the missing elements to the offspring in the same order in which they appear in the second parent.                
                child.ReplaceGene(i,
                    firstParentSwapGenes.Any(f => f.Index == i)
