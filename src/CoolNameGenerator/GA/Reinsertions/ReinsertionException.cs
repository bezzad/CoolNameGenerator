...
namespace CoolNameGenerator.GA.Reinsertions
{
    ...
    public sealed class ReinsertionException : Exception
    {
        ...
        public IReinsertion Reinsertion { get; }
        ...
        public ReinsertionException(IReinsertion reinsertion, string message)
            : base("{0}: {1}".With(reinsertion?.GetType().Name ?? string.Empty, message))
        {
        ...
        public ReinsertionException(IReinsertion reinsertion, string message, Exception innerException)
            : base("{0}: {1}".With(reinsertion?.GetType().Name ?? string.Empty, message), innerException)
        {
            Reinsertion = reinsertion;
        }
