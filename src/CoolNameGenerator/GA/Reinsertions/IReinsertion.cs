...
namespace CoolNameGenerator.GA.Reinsertions
{
    ...
    ///         population then a reinsertion scheme must be used to determine which individuals are to exist in the new
    ///         population
    ...
    public interface IReinsertion
    {
        ...
        IList<IChromosome> SelectChromosomes(IPopulation population, IList<IChromosome> offspring,
