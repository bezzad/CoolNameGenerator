...
namespace CoolNameGenerator.GA.Selections
{
    ...
    public class TournamentSelection : SelectionBase
    {
        ...
        protected override IList<IChromosome> PerformSelectChromosomes(int number, Generation generation)
        {
            ...
            {
                var randomIndexes = FastRandom.GetUniqueInts(Size, 0, candidates.Count);
                var tournamentWinner =
                    candidates.Where((c, i) => randomIndexes.Contains(i)).OrderByDescending(c => c.Fitness).First();
        ...
        /// </summary>
        /// <param name="size">
        ///     The size of the tournament, in other words, the number of chromosomes that will participate of each
        ///     tournament until all need chromosomes be selected.
        /// </param>
        ...
        ///     tournament until all need chromosomes be selected.
        /// </param>
        /// <param name="allowWinnerCompeteNextTournament">
        ///     If allow any winner in a tournament participate in the next tournament,
        ...
        ///     <remarks>
        ///         In other words, the number of chromosomes that will participate of each tournament until all need chromosomes
        ///         be selected.
        ///     </remarks>
        /// </summary>
